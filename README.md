# Excel-Dashboards
Bike Purchase
We have 13 attributes in the dataset, such as ID, Marital Status, Gender, Income, Children, Education, Occupation, Home Owner, Cars, Commute Distance, Region, Age, and Purchased Bike. Our goal is to identify the type of people likely to purchase a bike. All attributes, except ID and Purchased Bike, can be analyzed to find a pattern. The Purchased Bike field will provide the final output.
Limitations:
